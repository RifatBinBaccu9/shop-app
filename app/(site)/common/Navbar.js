...
const Navbar = () => {
  ...
  const isActive = (path) =>
    pathname === path ? "text-[#D96936]" : "text-black";
  return (
    <nav className="fixed top-0 w-full border-b border-[#E5E5E5] select-none lg:py-0 py-3 bg-[#FFFFFF] z-50">
      <div className=" relative ">
        <div className="flex justify-between items-center container">
          ...
          <div className="flex items-center sm:space-x-[30px] space-x-[10px]">
            ...
            <div className="lg:hidden sm:text-5xl text-3xl cursor-pointer">
              <HiOutlineMenu />
            </div>
          </div>
        </div>
